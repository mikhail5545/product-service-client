...
const (
	SeminarService_Ping_FullMethodName          = "/proto.product_service.seminar.v1.SeminarService/Ping"
	SeminarService_Create_FullMethodName        = "/proto.product_service.seminar.v1.SeminarService/Create"
	SeminarService_Update_FullMethodName        = "/proto.product_service.seminar.v1.SeminarService/Update"
	SeminarService_CreateVariant_FullMethodName = "/proto.product_service.seminar.v1.SeminarService/CreateVariant"
	SeminarService_UpdateVariant_FullMethodName = "/proto.product_service.seminar.v1.SeminarService/UpdateVariant"
	SeminarService_Publish_FullMethodName       = "/proto.product_service.seminar.v1.SeminarService/Publish"
)
...
func (c *seminarServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
...
func (UnimplementedSeminarServiceServer) Ping(context.Context, *PingRequest) (*PingResponse, error) {
...
func _SeminarService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SeminarServiceServer).Ping(ctx, req.(*PingRequest))
	}
...
var SeminarService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.product_service.seminar.v1.SeminarService",
	...
	Metadata: "proto/product_service/seminar/v1/seminar.proto",
}
